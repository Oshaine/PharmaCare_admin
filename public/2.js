...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    medication: function medication(e) {
      ...
      this.prescription_orders.map(function (v) {// console.log(v);
      });
      var temp = [];
