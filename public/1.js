  ...
  data: function data() {
    ...
    return {
      ...
      editedItem: (_editedItem = {
        ...
        strength: "",
        usage: []
      }, _defineProperty(_editedItem, "strength", ""), _defineProperty(_editedItem, "dosage", ""), _defineProperty(_editedItem, "image", []), _defineProperty(_editedItem, "units", 0), _defineProperty(_editedItem, "price_per_unit", 0.0), _editedItem),
      defaultItem: (_defaultItem = {
        ...
        strength: "",
        usage: []
      }, _defineProperty(_defaultItem, "strength", ""), _defineProperty(_defaultItem, "dosage", ""), _defineProperty(_defaultItem, "image", []), _defineProperty(_defaultItem, "units", 0), _defineProperty(_defaultItem, "price_per_unit", 0.0), _defaultItem),
      url: "",
      errors: {}
    };
  },
...
function loadMedication() {
  ...
  return Object(_http_service__WEBPACK_IMPORTED_MODULE_0__["http"])().get('/medications?page=' + page);
} //delete medication
